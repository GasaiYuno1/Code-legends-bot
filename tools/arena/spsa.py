...
PARAMS = {
    "atk": (0.9094, 0.15, 0.2, 3.0),
    "def": (0.632, 0.15, 0.1, 3.0),
    "guard": (0.7098, 0.2, 0.0, 3.0),
    "guarddef": (0.0, 0.1, 0.0, 1.5),
    "ward": (1.2951, 0.3, 0.0, 4.0),
    "wardatk": (0.4867, 0.1, 0.0, 1.5),
    "lethal": (2.4226, 0.4, 0.0, 5.0),
    "drain": (0.2471, 0.1, 0.0, 1.5),
    "breakthrough": (0.0599, 0.06, 0.0, 1.0),
    "charge": (0.1739, 0.1, 0.0, 1.5),
    "hp": (0.1224, 0.04, 0.0, 0.8),
    "lowhp": (0.9664, 0.2, 0.0, 3.0),
    "midhp": (0.1011, 0.05, 0.0, 0.6),
    "hand": (1.6448, 0.2, 0.0, 3.0),
    "handrating": (0.1575, 0.15, 0.0, 1.5),
    "fragile1": (0.01, 0.15, 0.0, 1.5),
    "fragile2": (0.0364, 0.1, 0.0, 1.0),
    "blue": (0.3294, 0.2, 0.0, 2.0),
    "oppdraw": (1.4922, 0.3, 0.0, 4.0),
    "mydraw": (1.7079, 0.3, 0.0, 4.0),
    "reply": (0.95, 0.05, 0.3, 1.0),
    # драфт
    "curvew": (0.2007, 0.1, 0.0, 1.0),
    "selfw": (27.5079, 8.0, 0.0, 80.0),
    "itempenalty": (3.0446, 1.0, 0.0, 8.0),
}
