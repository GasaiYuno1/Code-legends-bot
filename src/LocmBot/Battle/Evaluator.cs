...
namespace Locm
{
    ...
    public sealed class Evaluator
    {
        ...
        public double HpW = 0.1;             // за 1 HP. Арена (A/B, только этот вес): 0.1 → 65.5% и 17-е место, 0.3 → 59.1% и 20-е; офлайн-метрики (совпадение с Legend 54.0% против 55.4%) здесь ошиблись
